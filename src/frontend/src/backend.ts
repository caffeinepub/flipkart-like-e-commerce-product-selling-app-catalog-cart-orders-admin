...
import type { Order as _Order, Product as _Product, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addCategory(arg0: string): Promise<CategoryId> {
        if (this.processError) {
            try {
    ...
    async addProduct(arg0: string, arg1: string, arg2: bigint, arg3: bigint, arg4: CategoryId): Promise<ProductId> {
        if (this.processError) {
            try {
    ...
    async checkout(arg0: string): Promise<OrderId> {
        if (this.processError) {
            try {
    ...
    async filterProductsByCategory(arg0: CategoryId): Promise<Array<Product>> {
        if (this.processError) {
            try {
    ...
    async getPopularProducts(arg0: bigint): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPopularProducts(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listProducts(arg0: bigint | null, arg1: bigint | null): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.listProducts(to_candid_opt_n11(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n11(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProduct(arg0: ProductId, arg1: string, arg2: string, arg3: bigint, arg4: bigint, arg5: CategoryId): Promise<void> {
        if (this.processError) {
            try {
